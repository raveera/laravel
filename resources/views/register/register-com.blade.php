...
@section('content')
    <div class="container" id="body2">
      <form class="form-singin" method="GET" action="addcompany">        
          <h2 class="form-signin-heading" id="blackhead" align="center">ลงทะเบียนสถานประกอบการ</h2><hr>
            ...
            <div class="col-sm-4" id="container1" >
              <h4 id="body"><b>ข้อมูลส่วนตัวสถานประกอบการ<b></h4>
                <label>ชื่อ-สกุล *</label>
                <input type="text" name="name" class="form-control" id="text" placeholder="ชื่อ-สกุล"required> <br>
                <label>ประเภทสถานประกอบการ *</label>  
                <input type="text" name="category" class="form-control" id="text" placeholder="ประเภทสถานประกอบการ "required> <br>
                <label>ที่อยู่ปัจจุบัน *</label>  
                <input type="text" name="address" class="form-control" id="text" placeholder="ที่อยู่ปัจจุบัน "required> <br>
                <label>โทรสาร *</label>  
                <input type="text" class="form-control" id="text" placeholder="โทรสาร "required> <br>
                <label>เบอร์โทรศัพท์ *</label>  
                <input type="text" name="tel" class="form-control" id="text" placeholder="เบอร์โทรศัพท์ "required> <br>
                <label>Website *</label>  
                <input type="text" class="form-control" id="text" placeholder="website "required> <br>
                <label>E-mail</label>  
